 ...
 *   c++ -std=c++14 -pthread -I../src 4_fitfunctions_demo.cpp -o 4_fitfunctions_demo.out -lgsl -lgslcblas
 * Compile with GPU support:
 *   nvcc -arch=<arch> -std=c++14 -rdc=true -x cu -Xptxas -O0 -Xptxas --disable-optimizer-constants -I../src 4_fitfunctions_demo.cpp -o 4_fitfunctions_demo.out -lgsl -lgslcblas
