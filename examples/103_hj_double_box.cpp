 ...
 *   c++ -std=c++14 -pthread -I../src 103_hj_double_box.cpp -o 103_hj_double_box.out -lgsl -lgslcblas
 * Compile with GPU support:
 *   nvcc -arch=<arch> -std=c++14 -rdc=true -x cu -Xptxas -O0 -Xptxas --disable-optimizer-constants -I../src 103_hj_double_box.cpp -o 103_hj_double_box.out -lgsl -lgslcblas
