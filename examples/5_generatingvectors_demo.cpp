 ...
 *   c++ -std=c++11 -pthread -I../src 5_generatingvectors_demo.cpp -o 5_generatingvectors_demo.out
 * Compile with GPU support:
 *   nvcc -std=c++11 -x cu -I../src 5_generatingvectors_demo.cpp -o 5_generatingvectors_demo.out
 */
