 ...
 *   nvcc -arch=<arch> -std=c++11 -x cu -Xptxas -O0 -Xptxas --disable-optimizer-constants -I../src 5_generatingvectors_demo.cpp -o 5_generatingvectors_demo.out -lgsl -lgslcblas
