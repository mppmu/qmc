...
TEST_CASE( "Modular Multiplication", "[mul_mod]" ) {
    ...
    SECTION( "Maximum unsigned long long int")
    {
        ...
        result = qmcutil::mul_mod<unsigned long long int,double,unsigned long long int>(b,b,a);
        REQUIRE( result == 1ull );

        result = qmcutil::mul_mod<unsigned long long int,double,unsigned long long int>(b,1ull,a);
        REQUIRE( result == 4503599627370495ull );

        result = qmcutil::mul_mod<unsigned long long int,double,unsigned long long int>(1ll,b,a);
        REQUIRE( result == 4503599627370495ull );

        result = qmcutil::mul_mod<unsigned long long int,double,unsigned long long int>(b,2ull,a);
        REQUIRE( result == 4503599627370494ull );

        result = qmcutil::mul_mod<unsigned long long int,double,unsigned long long int>(2ll,b,a);
        REQUIRE( result == 4503599627370494ull );
    ...
    SECTION( "a*b overflows long long int")
    {
        ...
        result = qmcutil::mul_mod<unsigned long long int,double,unsigned long long int>(c,d,e);
        REQUIRE( result == 93292437ull );

        result = qmcutil::mul_mod<unsigned long long int,double,unsigned long long int>(d,c,e);
        REQUIRE( result == 93292437ull );
    ...
    SECTION( "Random unsigned long long int")
    {
        ...
        result = qmcutil::mul_mod<unsigned long long int,double,unsigned long long int>(f,g,h);
        REQUIRE( result == 3867651019217ull );

        result = qmcutil::mul_mod<unsigned long long int,double,unsigned long long int>(g,f,h);
        REQUIRE( result == 3867651019217ull );
    };
    ...
    SECTION( "Zero")
    {
        ...
        result = qmcutil::mul_mod<unsigned long long int,double,unsigned long long int>(d,zero,e);
        REQUIRE( result == zero );

        result = qmcutil::mul_mod<unsigned long long int,double,unsigned long long int>(zero,d,e);
        REQUIRE( result == zero );
    };
