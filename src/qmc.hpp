...
// TODO - unsigned int MAXDIM = 20,
    ...
    private:
        ...
        template <typename F1, typename F2> void compute(const int i, const std::vector<U>& z, const std::vector<D>& d, T* r_element, const U r_size, const U total_work_packages, const U n, const U m, F1& func, const U dim, F2& integral_transform) const;
        ...
        void update(result<T,U>& res, U& n, U& m, std::vector<result<T,U>> & previous_iterations) const;
